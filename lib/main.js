...
module.exports.create = function(inFile, outFile, verbose) {
  var main = Object.create(Main)
  main.input = require('./input').create(inFile)
  main.output = require('./output').create(outFile)
  main.processor = require('./processor').create(main)
  main.logger = require('./logger').create(verbose)
  return main
}
